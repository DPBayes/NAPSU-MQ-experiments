...
if __name__ == "__main__":
    ...
    seed = rng_initialisation.get_seed(int(snakemake.wildcards.repeat_ind), epsilon, algo)
    ...
    if algo == "max-ent":
        ...
        rapi = rap_interface.RapInterface(df_data.int_tensor, query_sets, df_data.int_df.columns, df_data.values_by_col)
        start_time = time.time()
        rapi.run_rap(
