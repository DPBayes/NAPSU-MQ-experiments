...
caption="""
Runtimes of each inference run for the US Census experiment. Does not include the time 
...
combined_df.to_latex(
    str(snakemake.output.latex), index=True, header=True, label="tab:runtime-us-census", 
